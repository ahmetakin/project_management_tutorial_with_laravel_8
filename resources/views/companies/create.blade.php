      ...
      <h1>Create New Company</h1>
        <!-- Example row of columns -->
          <div class="row col-md-12 col-lg-12 col-sm-12" style="margin: 10px;">
            <form method="post" action="{{ route('companies.store') }}"><!-- post action url update method of controller -->
                ...
                <div class="form-group">
                    ...
                    <textarea placeholder="Enter Description" style="resize: vertical" id="company-content" required name="description" rows="5" spellcheck="false" class="form-control autosize-target text-left"></textarea>
                </div>
                <div class="form-group">
